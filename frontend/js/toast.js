/**
 * HyperPanel — Toast Notifications
 */
...
function showToast(title, message, type = 'info', duration = 4000) {
    ...
    const safeMessage = typeof escapeHtml === 'function' && message ? escapeHtml(message) : message;
    ...
    toast.innerHTML = `
        ...
        <div class="toast-close" onclick="this.parentElement.classList.add('removing'); setTimeout(() => this.parentElement.remove(), 300)">
